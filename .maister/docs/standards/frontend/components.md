...
### Vanilla DOM APIs
Client-side JavaScript uses vanilla DOM APIs (`querySelector`, `addEventListener`, `getComputedStyle`) without any JS framework dependency beyond Bootstrap's own JS. Do not introduce frontend frameworks (React, Vue, etc.) for this project.
